...
from miapp.models import Enfermedad, Enfermedadmaes, Enfermedadmara, Enfermedadsoho, Enfermedadsota, Enfermedadsora, Enfermedadtriho, Enfermedadtripla, Enfermedadtries
...
class EnfermedadtriesmaizForm(forms.ModelForm):

	class Meta:
		model = Enfermedadtries
