...
urlpatterns = [
    ...
    url(r'^analisistries/$', views.preferencetriesPage, name='preferencetriesPage'),
    url(r'^api/analisistries$', views.newPreferencetries, name='newPreferencetries'),
    url(r'^api/reviewstries$', views.processReviewstries, name='processReviewstries'),
    url(r'^agregartries/$', views.nuevotriesEnfermedadPage, name='nuevotriesEnfermedadPage'),
    url(r'^api/enfermedadestries$', views.creartriesEnfermedad, name='creartriesEnfermedad'),
    url(r'^escrituratries/$', views.escrituratriesPage, name='escrituratriesPage'),
    url(r'^api/escrituratries$', views.escrituratries, name='escrituratries'),
    url(r'^reportetriesmaiz/$', views.reportetriesmaizPage, name='reportetriesmaizPage'),
    url(r'^reportecalificacionmaiztries/$', views.reportecalificacionmaiztriesPage, name='reportecalificacionmaiztriesPage'),
    url(r'^accionestries/$', views.accionestriesPage, name='accionestriesPage'),
    url(r'^nuevotries/$', views.enfermedadtriesmaiz_view, name='enfermedadtriesmaiz_crear'),
    url(r'^editartries/(?P<id_enfermedadtriesmaiz>\d+)/$', views.enfermedadtriesmaiz_edit, name='enfermedadtriesmaiz_editar'),
    url(r'^eliminartries/(?P<id_enfermedadtriesmaiz>\d+)/$', views.enfermedadtriesmaiz_delete, name='enfermedadtriesmaiz_eliminar'),
]
